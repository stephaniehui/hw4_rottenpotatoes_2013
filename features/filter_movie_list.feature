...
Scenario: restrict to movies with 'PG' or 'R' ratings
  ...
  When I uncheck the following ratings: ratings_PG-13, ratings_NC-17, ratings_G
...
Scenario: all ratings selected
  # see assignment
  When I check the following ratings: ratings_PG, ratings_R, ratings_PG-13, ratings_NC-17, ratings_G
  When I press "ratings_submit"
